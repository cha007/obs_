...
{
	bUseCBR = 1;// AppConfig->GetInt(TEXT("Video Encoding"), TEXT("UseCBR"), 1) != 0;
	keyint = 0;// AppConfig->GetInt(TEXT("Video Encoding"), TEXT("KeyframeInterval"), 0);
...
void NVENCEncoder::init()
{
    ...
    dontTouchConfig = false;
	bool is2PassRC = 1;// AppConfig->GetInt(TEXT("Video Encoding"), TEXT("NVENC2Pass"), 1) != 0;

	String profileString = TEXT("main");// AppConfig->GetString(TEXT("Video Encoding"), TEXT("X264Profile"), TEXT("high"));

	String presetString = TEXT("Default");// AppConfig->GetString(TEXT("Video Encoding"), TEXT("NVENCPreset"), TEXT("Automatic"));
    ...
    if (!dontTouchConfig)
    {
        ...
        if (bUseCBR)
        {
			bool filler = 1;// AppConfig->GetInt(TEXT("Video Encoding"), TEXT("PadCBR"), 1) != 0;
            if (is2PassRC)
            {
